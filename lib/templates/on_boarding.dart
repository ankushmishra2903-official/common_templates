...
class OnBoardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return EasyOnboarding(
      ...
      backButtonColor: Colors.blue.shade900,
      nextButtonColor: Colors.blue.shade900,
      backgroundColor: Colors.white,
      indicatorSelectedColor: Colors.blue.shade900,
      indicatorUnselectedColor: Colors.blueGrey,
      startButtonColor: Colors.blue.shade900,
      nextButtonIcon: Icon(
        Icons.arrow_forward,
        color: Colors.white,
      ),
